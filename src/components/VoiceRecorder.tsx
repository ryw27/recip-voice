...
export default function VoiceRecorder() {
  ...
  return (
    <div className="flex w-3/4 h-2/5 justify-center items-center flex-col"> 
      {(isRecording || transcript) &&
        <div className="w-1/2 bg-white text-black flex flex-col rounded-lg p-12 mb-[24] text-center">
      ...
      <button onClick={isRecording ? stopRecording : startRecording} 
              className={`rounded-full w-[50px] h-[50px] bg-red-400 flex items-center justify-center ${isRecording ? 'animate-pulse' : ''}`}>
        <svg className="w-10 h-10" data-slot="icon" aria-hidden="true" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
